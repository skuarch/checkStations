...
/**
 * Generic Data Access Object. Each method close the session with hibernate.
 *
 * @author skuarch
 */
public class DAO {
    ...
    //==========================================================================
    /**
     * create a instance.for use this class please don't create a object, <br />
    ...
    //==========================================================================
    /**
     * search in database using a like, example: select * from table where filed
     * like "stringToFind%";
     *
     * @param clazz Class
